          ...
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
                ...
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <Link
                        href="#"
                        className={`group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-black duration-300 ease-in-out hover:bg-[#f15a23] hover:text-white dark:hover:bg-meta-4 ${
                          (pathname === "/" ||
                            pathname.includes("dashboard")) &&
                          "bg-[#f15a23] text-white dark:bg-meta-4"
                        }`}
                        onClick={(e) => {
                          e.preventDefault();
                          sidebarExpanded
                      ...
                      >
                        <ul className="mb-5.5 mt-4 flex flex-col gap-2.5 pl-6">
                          <li>
                            <Link
                              href="/"
                              className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-[#f15a23] ${
                                pathname === "/" && "text-[#f15a23]"
                              }`}
                            >
                              eCommerce
                            </Link>
              ...
              <li>
                <Link
                  href="/calendar"
                  className={`group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-black duration-300 ease-in-out hover:text-white hover:bg-orange-500 dark:hover:bg-meta-4 ${
              ...
              <li>
                <Link
                  href="/profile"
                  className={`group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-black duration-300 ease-in-out hover:text-white hover:bg-[#f15a23] dark:hover:bg-meta-4 ${
                    pathname.includes("profile") && "bg-[#f15a23] text-white dark:bg-meta-4"
                  }`}
                >
                  <svg
                    className="fill-current"
              ...
              <li>
                <Link
                  href="/tables"
                  className={`group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-black duration-300 ease-in-out hover:text-white hover:bg-[#f15a23] dark:hover:bg-meta-4 ${
                    pathname.includes("tables") && "bg-[#f15a23] dark:bg-meta-4"
                  }`}
                >
                  <svg
                    className="fill-current"
          ...
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              <li>
                <Link
                  href="/chart"
                  className={`group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-black duration-300 ease-in-out hover:bg-[#f15a23] dark:hover:bg-meta-4 ${
                    pathname.includes("chart") && "bg-[#f15a23] dark:bg-meta-4"
                  }`}
                >
                  <svg
                    className="fill-current"
                        ...
                        <ul className="mb-5.5 mt-4 flex flex-col gap-2.5 pl-6">
                          <li>
                            <Link
                              href="/ui/alerts"
                              className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-[#f15a23] ${
                                pathname === "/ui/alerts" && "text-[#f15a23]"
                              }`}
                            >
                              Alerts
                            </Link>
                          ...
                          <li>
                            <Link
                              href="/ui/buttons"
                              className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-[#f15a23] ${
                                pathname === "/ui/buttons" && "text-[#f15a23]"
                              }`}
                            >
                              Buttons
                            </Link>
                        ...
                        <ul className="mb-5.5 mt-4 flex flex-col gap-2.5 pl-6">
                          <li>
                            <Link
                              href="/auth/signin"
                              className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-[#f15a23] ${
                                pathname === "/auth/signin" && "text-[#f15a23]"
                              }`}
                            >
                              Sign In
                            </Link>
                          ...
                          <li>
                            <Link
                              href="/auth/signup"
                              className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-[#f15a23] ${
                                pathname === "/auth/signup" && "text-[#f15a23]"
                              }`}
                            >
                              Sign Up
                            </Link>
