...
const SignIn: React.FC = () => {
  return (
    <>
    <div className="w-full sm:h-full xl:h-screen">
     <div className="flex flex-wrap items-center justify-center xl:py-7 xl:border-l-2">
       <div className="flex rounded-2xl w-full sm:mt-10 bg-gray drop-shadow-xl xl:w-1/2">
         <div className="w-full h-screen sm:h-full border-stroke xl:w-1/2 xl:border-l-2">
           <div className="w-full h-full xl:py-0 sm:py-6">
             <div className="ml-5 mt-3 items-center flex flex-col">
             <Image src='/images/BNI_logo.svg' width={150} height={300} alt="logo" className="flex flex-auto justify-center items-center py-15"/>
               <span className="text-2xl text-center font-semibold font-Poppins">Welcome to Ideabox</span>
               <span className="font-light text-center">{'let login to get started using ideabox apps'}</span>
             </div>
           </div>
             <div className="py-5 px-5 flex flex-col items-center">
             <input type="text" placeholder="Username" className="input input-bordered w-full max-w-xs mb-4 h-12 bg-white" />
             <input type="password" placeholder="Password" className="input input-bordered w-full max-w-xs h-12 bg-white" />
             </div>
