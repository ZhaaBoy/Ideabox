          ...
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              <li>
                <Link
                  href="/dashboard"
                  className={`group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-slate-700 duration-300 ease-in-out hover:bg-primary hover:text-slate-200 ${
                    pathname.includes("dashboard") &&
                    "bg-primary text-slate-200 dark:bg-meta-4"
                  }`}
                >
                  <svg
                    className="fill-current"
